...
interface IFutureClasses extends IClasses{
	willStartsAt: string;
}
type CurrClientProp = 'name' | 'age' | 'gender' | 'timeLeft';
type CurrClientsType = {
	[K in CurrClientProp]: string | number;
}
...
interface IFitnessClubCenter {
	...
	exClients: ExClientsType[];
	futureClients: FutureClientsType[];
}
